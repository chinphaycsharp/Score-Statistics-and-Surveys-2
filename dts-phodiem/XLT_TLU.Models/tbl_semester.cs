namespace XLT_TLU.Models
{
    ...
    public partial class tbl_semester
    {
        ...
        public string eid { get { return StringHelper.Encrypt(id.ToString()+ "_"+semester_code); } }
        public string did { get { return StringHelper.Decrypt(eid).Split('_')[1].ToString(); } }
