namespace XLT_TLU.Models.DTSModels
{
    ...
    public partial class tbl_student_semester_summary_mark
    {
        ...
        public int? total_learning_credit { get; set; }

        public int? total_learning_credit_n2 { get; set; }
        ...
        public long? school_year_mark_id { get; set; }

        public long? semester_id { get; set; }

        public long? student_id { get; set; }

        public long? summary_mark_id { get; set; }
